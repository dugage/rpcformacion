...
class __Mustache_d61d7bfc07a39c95a228b09df330cdfa extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section431e9bbd2039c9b36aeadfd15f578459($context, $indent, $value);
        $buffer .= $indent . '        </div>
';
        $buffer .= $indent . '    </div>
';
...
';
        ...
        $buffer .= $this->section158c577a5a589a3e7755de7e96202c83($context, $indent, $value);
        $buffer .= $indent . '</tbody>
';
        $buffer .= $indent . '</table>
';
...
';
    ...
    private function section431e9bbd2039c9b36aeadfd15f578459(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
...
';
    ...
    private function section067ed1146f6c4e0d5fa384a072e5ad39(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
        ...
        ';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '        <span class="drag-handlecontainer pull-left"></span>
';
...
';
    ...
    private function sectionF2ae0edad3e9d042d0cb66c79eeaf95e(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
...
';
    ...
    private function section18717034ad618a5f33b2cdeb86dec5fb(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
...
';
    ...
    private function section7f5de55d46c511c53195caacf5e27262(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
...
';
    ...
    private function section158c577a5a589a3e7755de7e96202c83(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
...
';
                // 'canmanagecoursecompetencies' section
                $value = $context->find('canmanagecoursecompetencies');
                $buffer .= $this->section067ed1146f6c4e0d5fa384a072e5ad39($context, $indent, $value);
                // 'competency' section
                ...
                $buffer .= $this->sectionF2ae0edad3e9d042d0cb66c79eeaf95e($context, $indent, $value);
                ...
                // 'canmanagecoursecompetencies' section
                $value = $context->find('canmanagecoursecompetencies');
                $buffer .= $this->section18717034ad618a5f33b2cdeb86dec5fb($context, $indent, $value);
                $buffer .= $indent . '        <div data-region="coursecompetencyactivities">
';
                $buffer .= $indent . '        <p>
';
                $buffer .= $indent . '        <ul class="inline">
';
                // 'coursemodules' section
                $value = $context->find('coursemodules');
                $buffer .= $this->section7f5de55d46c511c53195caacf5e27262($context, $indent, $value);
                // 'coursemodules' inverted section
                $value = $context->find('coursemodules');
                if (empty($value)) {
                    
                    $buffer .= $indent . '            <li><span class="alert">';
                    // 'str' section
                    $value = $context->find('str');
