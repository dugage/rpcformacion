...
class __Mustache_4d1707f42a7a1ddc7eb9d6fca01d76a9 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section7b94dc608638e420766086fbb417fe1b($context, $indent, $value);
        $buffer .= $indent . '    </tbody>
';
        $buffer .= $indent . '</table>
';
...
';
    ...
    private function sectionD422c3d73340d08b0c0dfa639c25ea1a(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
...
';
    ...
    private function section7b94dc608638e420766086fbb417fe1b(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
...
';
                ...
                $buffer .= $this->sectionD422c3d73340d08b0c0dfa639c25ea1a($context, $indent, $value);
                $buffer .= $indent . '            </td>
';
                $buffer .= $indent . '        </tr>
';
